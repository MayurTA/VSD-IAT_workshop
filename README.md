...
- [DAY 2 : Floorplanning and introduction to Library Cells](#day-2--floorplanning-and-introduction-to-library-cells)
  ...
  - [LAB 2 : Floorplanning, placement and magic](#lab-2--floorplanning-placement-and-magic)
     - [Few useful flags and commands](#few-useful-flags-and-commands)
     - [Running floorplan](#running-floorplan)
     - [Opening floorplan in MAGIC](#opening-floorplan-in-magic)
     - [Running placement](#running-placement)
     - [Opening floorplan in MAGIC](#opening-floorplan-in-magic-1)
- [DAY 3 : Designing library cell using MAGIC layout and ngspice charactereization](#day-3--designing-library-cell-using-magic-layout-and-ngspice-charactereization)
  ...
  - [LAB 3 : Simulation and characterization of an inverter and plugging it into picorv32](#lab-3--simulation-and-characterization-of-an-inverter-and-plugging-it-into-picorv32)
    - [Setting up the inverter files](#setting-up-the-inverter-files)
...
- [DAY 4 : Pre-layout timing analysis and importance of good clock tree](#day-4--pre-layout-timing-analysis-and-importance-of-good-clock-tree)
  - [LAB 4 : Clock tree synthesis and tritonCTS](#lab-4--clock-tree-synthesis-and-tritoncts)
    - [Verifying the gudidelines and coverting to lef file](#verifying-the-gudidelines-and-coverting-to-lef-file)
    - [Plugging the inverter lef file into picorv32a](#plugging-the-inverter-lef-file-into-picorv32a)
    - [Timing analysis in OpenSTA](#timing-analysis-in-opensta)
    - [Clock tree synthesis](#clock-tree-synthesis)
    - [Running OpenSTA using OpenRoad](#running-opensta-using-openroad)
